          ...
          <Card className="grid gap-3 max-w-7xl">
            ...
            <CardContent className="grid gap-3 max-w-7xl">
              <div className="grid gap-3"> {/* form 태그 제거 */}
                ...
                {routeItems.length > 0 && ( /* ... Table rendering ... */
                ...
                <Button type="button" onClick={submit_new} className="mt-6 max-w-7xl">요청 제출</Button> {/* type="button" 및 onClick 수정 */}
              </div> {/* form 태그 제거 */}
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="grid gap-3 max-w-7xl">
            ...
            <CardContent className="grid gap-3 max-w-7xl">
              <div className="grid gap-3"> {/* form 태그 제거 */}
                ...
                {editItems.length > 0 && ( /* ... Table rendering ... */
                  <div className="mt-6 border rounded-lg overflow-x-auto">
                ...
                <Button type="button" onClick={submit_edit} className="mt-6 max-w-7xl">요청 제출</Button> {/* type="button" 및 onClick 수정 */}
              </div> {/* form 태그 제거 */}
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-3 max-w-7xl"> {/* form 태그 제거 */}
                ...
                />
                <Button type="button" onClick={submit_etc} className="mt-6 max-w-7xl">요청 제출</Button> {/* type="button" 및 onClick 수정 */}
              </div> {/* form 태그 제거 */}
            </CardContent>
          </Card>
        </TabsContent>
